...
import com.arjuna.inbrief.ui.viewModel.ArticleViewModel

@RequiresApi(Build.VERSION_CODES.O)
@Composable
fun Article(articleViewModel: ArticleViewModel = hiltViewModel()) {
    Box(
        ...
        LazyColumn(modifier = Modifier.padding(16.dp)) {
            item {
                ...
                Text(
                    ...
                    style = TextStyle(
                        MaterialTheme.colorScheme.onBackground, 22.sp, FontWeight.Bold, lineHeight = 22.sp,
                ...
                Spacer(modifier = Modifier.height(8.dp))
                Text(
                    text = "URL : ${selectedArticle.url}",
                    modifier = Modifier
                        .padding(8.dp)
                        .clickable {
                            Intent(selectedArticle.url)
                        },
                    style = TextStyle(
                        fontSize = 14.sp,
                        lineHeight = 14.sp,
